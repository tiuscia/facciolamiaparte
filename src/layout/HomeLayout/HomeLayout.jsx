...
const HomeLayout = () => {
  return (
    <div>
      <Header
        title="faccio la mia parte"
        text="L’isolamento ci mette alla prova, qui cerchiamo di raccogliere anche il più piccolo elemento che ci può aiutare a superarlo.
